...
class ManagementUserController extends Controller{
    ...
    public function index(){
        $nama = "Kristopher Yohanes Immanuel Tambunan";
    ...
    public function store(Request $request){
        return "Method ini nantinya akan digunakan menciptakan data user yang baru";
    }
    ...
    public function destroy($id){
        return "Method ini nantinya akan digunakan untuk menghapus data dengan id=" . $id;
    }
}